	...
	$.fn.zySearch = function(options,param){
		...
		return this.each(function(){
			...
			this.createHtml = function(){
                ...
                html += '<form action="https://s.2.taobao.com/list/list.htm" method="get">';
                html += '<input type="hidden" name="_input_charset" value="utf8">';
				html += '<input id="searchInput" class="search-input" name="q" type="text" placeholder="搜索宝贝……">';
